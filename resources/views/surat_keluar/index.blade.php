...
<body>
    ...
    <div class="container mt-4">
        <div class="row" style="margin-top: 300px;">
            <div class="col-md-4">
                <a href="{{ route('users.index') }}" style="padding: 50px;" class="btn btn-primary btn-lg btn-block mb-3">Kelola Pengguna</a>
            </div>
            <div class="col-md-4">
                <a href="{{ route('kepala_surat.index') }}" style="padding: 50px;" class="btn btn-success btn-lg btn-block mb-3">Kelola Kepala Surat</a>
            </div>
            <div class="col-md-4">
                <a href="{{ route('surat_keluar.index') }}" style="padding: 50px;" class="btn btn-info btn-lg btn-block mb-3">Kelola Surat Keluar</a>
            </div>
        </div>
    </div>
</body>
